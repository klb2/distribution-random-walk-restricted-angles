...
python truncation_error.py -v -N 30 -a 0.5
python truncation_error.py -v -N 30 -a 1.25

echo "OtA example"
python example_ota_computation.py -v --plot -N 2
python example_ota_computation.py -v --plot -N 30
